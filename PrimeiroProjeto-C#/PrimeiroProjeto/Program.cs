...
string mensagemDeBoasVindas = "Boas Vindas ao Screen Soun";
...
{
    Console.Clear();
    ExibirTituloDaOpcao("Registo de bandas");
...
{
    Console.Clear();
    ExibirTituloDaOpcao("Exibindo todas a bandas registradas");
...
void AvaliarUmaBanda()
{
    ...
    {
        Console.Write($"QUal a noto que a banda {nomeDaBanda} merece: ");
